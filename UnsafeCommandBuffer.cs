...
namespace UnityEngine.Rendering
{
    ...
    public class UnsafeCommandBuffer : BaseCommandBuffer, IUnsafeCommandBuffer
    {
        ...
        internal UnsafeCommandBuffer(
            CommandBuffer wrapped,
            RenderGraphPass executingPass,
            bool isAsync
        )
        ...
        public void RequestAsyncReadbackIntoNativeArray<T>(
            ...
            where T : struct
        {
            m_WrappedCommandBuffer.RequestAsyncReadbackIntoNativeArray(output, src, callback);
        }
        ...
        {
            m_WrappedCommandBuffer.ClearRenderTarget(
                clearDepth,
                clearColor,
                backgroundColor,
                depth
        ...
        {
            ThrowIfGlobalStateNotAllowed();
            m_WrappedCommandBuffer.EnableKeyword(rayTracingShader, keyword);
        }
        ...
        {
            ThrowIfGlobalStateNotAllowed();
            m_WrappedCommandBuffer.DisableKeyword(rayTracingShader, keyword);
        }
        ...
        public void SetKeyword(
            ...
            in LocalKeyword keyword,
            bool value
        )
        {
            ThrowIfGlobalStateNotAllowed();
            m_WrappedCommandBuffer.SetKeyword(rayTracingShader, keyword, value);
        }
        ...
        {
            m_WrappedCommandBuffer.MarkLateLatchMatrixShaderPropertyID(
                matrixPropertyType,
                shaderPropertyID
            );
        }
        ...
        public void SetComputeIntParams(
            ComputeShader computeShader,
            string name,
            params int[] values
        )
        ...
        {
            m_WrappedCommandBuffer.SetComputeTextureParam(
                computeShader,
                kernelIndex,
                name,
                rt,
        ...
        {
            m_WrappedCommandBuffer.SetComputeBufferParam(
                computeShader,
                kernelIndex,
                nameID,
                buffer
        ...
        {
            m_WrappedCommandBuffer.SetComputeConstantBufferParam(
                computeShader,
                nameID,
                buffer,
                offset,
        ...
        {
            m_WrappedCommandBuffer.SetComputeParamsFromMaterial(
                computeShader,
                kernelIndex,
                material
            );
        ...
        {
            m_WrappedCommandBuffer.SetRayTracingConstantBufferParam(
                rayTracingShader,
                nameID,
                buffer,
                offset,
        ...
        public void SetRayTracingFloatParam(
            RayTracingShader rayTracingShader,
            string name,
            float val
        )
        ...
        {
            m_WrappedCommandBuffer.DispatchRays(
                rayTracingShader,
                rayGenName,
                width,
                height,
        ...
        {
            m_WrappedCommandBuffer.DrawMesh(
                mesh,
                matrix,
                material,
                submeshIndex,
        ...
        /// <param name="offset">[See CommandBuffer documentation](https://docs.unity3d.com/ScriptReference/Rendering.CommandBuffer.SetGlobalConstantBuffer.html)</param>
        /// <param name="size">[See CommandBuffer documentation](https://docs.unity3d.com/ScriptReference/Rendering.CommandBuffer.SetGlobalConstantBuffer.html)</param>
        public void SetGlobalConstantBuffer(
            GraphicsBuffer buffer,
            string name,
            int offset,
            int size
        ...
        {
            m_WrappedCommandBuffer.IssuePluginCustomBlit(
                callback,
                command,
                source,
                dest,
        ...
        {
            m_WrappedCommandBuffer.IssuePluginCustomTextureUpdateV2(
                callback,
                targetTexture,
                userData
            );
